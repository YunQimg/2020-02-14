  ...
  function go() {
    typish('#typer')
      ...
      .type('今天袁先生教你写代码呀', '<span class="note">')
      .type('0', '<br>')
      .type('00', '<span class="blank">')
      .wait(10)
      .type('等下。。。', '<span class="note">') 
      .wait(10)
      .type('送你朵小花❀', '<span class="note">', 0)
      .wait(10)
      .type('0', '<br>')
      .type('*/', '<span class="note">') 
      .type('0', '<br>')
      ...
      .type('forhalflifefate', '<span class="blue">')
      ...
      .type(':', '<span class="blue">')
      .type('0', '<span class="blank">')
      .type("'半毛钱'", '<span class="green">')
      .wait(15)
      .del(6)
      .type("'袁先森'", '<span class="green">')
      .type(',', '<span class="gray">')
      .type('0', '<br>')
      // 慧慧
      .type('0000', '<span class="blank">')
      ...
      .type(':', '<span class="blue">')
      .type('0', '<span class="blank">')
      .type("'2017-10-14'", '<span class="green">')
      .type('0', '<br>')
      .type('00', '<span class="blank">')
      .type('}', '<span class="gray">')
      .type('0', '<br>')
  ...
  function count() {
    const date = new Date('2017/10/14 13:58:00')
    let end = new Date()
